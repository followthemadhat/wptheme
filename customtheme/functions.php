...
function customtheme_scripts() {
	...
	wp_enqueue_script( 'customtheme-libs', get_template_directory_uri() . '/js/libs.min.js', array('jquery'), '20151215', true );

	wp_enqueue_script( 'customtheme-scripts', get_template_directory_uri() . '/js/main.js', array('jquery'), '20151215', true );
